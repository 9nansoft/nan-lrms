...
// route to mint a NN-LRMS webhook API key for their registered hospital,
// then pushes the key into HOSxP's `webhook_setting` table (module_id=3,
// setting_code='NN-LRMS') via BMS REST. This route does NOT touch HOSxP —
// it only provisions the NN-LRMS side.
//

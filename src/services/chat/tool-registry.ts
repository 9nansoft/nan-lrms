  ...
  load_playbook: {
    ...
    tool: {
      ...
      function: {
        name: 'load_playbook',
        description:
          'โหลดคู่มือการทำงานเฉพาะของระบบ NN-LRMS (เกณฑ์ CPD, การอ่าน partograph, ระดับ ANC, SLA การส่งต่อ, กฎการรายงานสถิติ) — **ใช้ก่อนตอบ** เมื่อคำถามเกี่ยวกับหัวข้อเหล่านี้ เพราะเป็นกติกาเฉพาะของระบบนี้ที่เดาเองไม่ได้ **อย่าใช้เมื่อ** ถามความรู้ทางการแพทย์ทั่วไป (ใช้ ask_medical_ebook)',
        parameters: {
          type: 'object',
          properties: {
            id: {

...
const DEMO_PATIENTS: DemoPatient[] = [
  // รพ.น่าน (10716) — 2 patients, 1 high-risk
  {
    ...
    hospitalHcode: '10716', admitHoursAgo: 8,
  ...
  },
  {
    ...
    hospitalHcode: '10716', admitHoursAgo: 4,
    cervixReadings: [2, 3, 4],
  },
  // รพ.เวียงสา (11177) — 1 patient, medium risk
  {
    ...
    hospitalHcode: '11177', admitHoursAgo: 6,
    cervixReadings: [4, 5, 6],
  },
  // รพ.สมเด็จพระยุพราชปัว (11453) — 2 patients, 1 high-risk
  {
    ...
    hospitalHcode: '11453', admitHoursAgo: 12,
  ...
  },
  {
    ...
    hospitalHcode: '11453', admitHoursAgo: 2,
    cervixReadings: [3],
  },
  // รพ.นาน้อย (11175) — 1 patient, low risk
  {
    ...
    hospitalHcode: '11175', admitHoursAgo: 3,
    cervixReadings: [5, 6, 7, 8],
  },
  // รพ.แม่จริม (11173) — 2 patients
  {
    ...
    hospitalHcode: '11173', admitHoursAgo: 5,
  ...
  },
  {
    ...
    hospitalHcode: '11173', admitHoursAgo: 10,
    cervixReadings: [2, 3, 4, 5, 5, 6],
  },
  // รพ.บ้านหลวง (11174) — 1 patient, high risk
  {
    ...
    hospitalHcode: '11174', admitHoursAgo: 14,

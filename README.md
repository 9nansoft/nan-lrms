...
NN-LRMS เชื่อมข้อมูลจาก HOSxP ผ่าน browser-side gateway หรือ Webhook API แล้วจัดข้อมูลเป็นภาพรวมระดับจังหวัด ทะเบียนการตั้งครรภ์ งานห้องคลอด การส่งต่อ และผลลัพธ์ทารก ค่าเริ่มต้นของระบบมีเครือข่ายโรงพยาบาล 26 แห่งในจังหวัดขอนแก่น ผู้ดูแลสามารถเปลี่ยนจังหวัดหลักของ deployment และเพิ่มโรงพยาบาลจากทะเบียนที่ bundle มากับระบบได้
...
| วิดีโอปรึกษา | เรียกผู้ใช้ออนไลน์หรือโรงพยาบาลเข้ากลุ่มสูงสุด 8 คนผ่าน Jitsi; สื่อเสียง/ภาพไม่วิ่งผ่านเซิร์ฟเวอร์ NN-LRMS |
...
- ความพร้อมใช้งานของ BMS, ProviderID และ Jitsi อยู่นอกขอบเขต uptime ของ NN-LRMS
